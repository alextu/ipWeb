...
public class Session extends CRIWebSession {
	...
	private CRIBasicDataBus dataBus;
	...
	public Session() {
		...
		dataBus = new CRIBasicDataBus(monEc);
...
//		}
	...
	public String email() { 
		if (monCC != null && monCC.compteCourant() != null && monCC.compteCourant().cpt != null) {
			EOCompte leCpt = monCC.compteCourant().cpt;
...
//		Envoyer une notification a tous les observateurs :
	...
	public NSTimestamp[] chercherDatesDiplSem(Integer fspnKey,Integer sem) {
		return ((Application)criApp).chercherDatesDiplSem(fspnKey,sem,new Integer(getAnneeEnCours()) );
	}
	...
	public boolean autoriseIpRedoublant(Integer fspnKey,Integer sem) {
		return ((Application)criApp).autoriseRedoublants(fspnKey,sem,new Integer(getAnneeEnCours()) );
	}
...
//		return true;
	...
	public boolean envoitMail(String titreMail, String leMsg, String nomFichier, NSData lesDatas) {
		...
		CRIMailBus leBusDeMail = monApp.getMailBus();
		boolean bienPasse;
